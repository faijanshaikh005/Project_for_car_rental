...
# from .views import BookYourCar,contact,loginUser,index,customerdashboard, about, recover_forgot_password, registers, Cars,tata
# from . import views


# urlpatterns = [
#     path('admin/', admin.site.urls),
#     path('/BookYourCar.html', views.BookYourCar, name='Cardetail'),
